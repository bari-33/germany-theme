...
@section('content')
    <!-- Validation -->
    <h1>{{ __('locale.Update Product') }}</h1>
    @if (session('alert'))
                            ...
                            <div class="row">
                                <div class="col-md-8 row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input class="form-control " id="product_title" type="text" required="required"
                                            name="product_title" value="{{$product->product_title}}" placeholder="{{ __('locale.Product Name') }}" />
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input class="form-control" id="regular_price" name="regular_price" type="text"
                                          value="{{$product->regular_price}}"  placeholder="{{ __('locale.Regular price') }}" required />
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" id="promotional_price" class="form-control"
                                            name="promotional_price" value="{{$product->promotional_price}}" placeholder="{{ __('locale.Promotional price') }}"
                                             />
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="subtitle">
                                        ...
                                        <input class="form-control" id="subtitle" name="subtitle" required="required"
                                            type="text" value="{{$product->product_subtitle}}" placeholder="{{ __('locale.Subtitle') }}" />
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="Status">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-content">
                                                <img id="preview_img" src="{{ asset('images/products/' . $product->product_image) }}"
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Deutsch" name="language" {{$product->language=="Deutsch"?'checked':''}} required>
                                        <label for="language">{{ __('locale.German') }}</label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Englisch" name="language" {{$product->language=="Englisch"?'checked':''}}>
                                        <label for="language">{{ __('locale.English') }}</label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Spanisch" name="language" {{$product->language=="Spanisch"?'checked':''}} >
                                        <label for="language">{{ __('locale.Spanish') }}</label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Französisch" name="language" {{$product->language=="Französisch"?'checked':''}}>
