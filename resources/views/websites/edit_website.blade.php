...
@section('content')
    <!-- Validation -->
    <h1>{{ __('locale.Update Websites') }}</h1>
    @if (session('alert'))
    ...
    <section class="bs-validation">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ url('updatewebsite/'.$website->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-12 row">
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <input class="form-control " id="website_title" type="text" required="required"
                                            name="website_title" value="{{$website->website_title}}" placeholder="{{ __('locale.Product Name') }}" />
                                    </div>
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        value="{{$website->regular_price}}"  placeholder="{{ __('locale.Regular price') }}" required />
                                    </div>
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <input type="text" id="promotional_price" class="form-control"
                                            name="promotional_price" value="{{$website->promotional_price}}" placeholder="{{ __('locale.Promotional price') }}"
                                             />
                                    </div>
                                    <div class="col-md-4 form-group mb-3">
                                        <label for="category">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-content">
                                                <img id="preview_img" src="{{ asset('images/websites/primary/' . $website->primary_image) }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <a class="css" id="img1" onclick="remove1(this)"><i
                                                    ...
                                                    style="font-size: 1em;"></i></a>
                                            <div class="card-content">
                                                <img id="preview_img1" src="{{ asset('images/websites/secondary/' . $website->secondary_image) }}"
                                                    class="" width="200" height="150" />
