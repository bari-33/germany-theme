...
@section('content')
    <!-- Validation -->
    <h1>{{ __('locale.Update category') }}</h1>
    @if (session('alert'))
    ...
    <section class="bs-validation">
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ url('categoryupdate/'.$data->id.'/'.$flag) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" value="{{$data->name}}"  placeholder="{{ __('locale.Category Name') }}" required>
                                        @error('name')
