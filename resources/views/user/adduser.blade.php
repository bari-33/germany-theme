                        ...
                        <form action="{{ url('store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-8 row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            name="password" id="password" placeholder="{{ __('locale.Password') }}"
                                            required>
                                        @error('password')
                                ...
                                <div class="col-md-4">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <a   class="css" id="img" onclick="remove(this)"><i class="fa fa-times" aria-hidden="true" style="font-size: 1em;"></i></a>
                                            <div class="card-content">
                                                <img id="preview_img" src="{{ asset('images/profiles/profile.png') }}"
                                                    class="" width="200" height="150" />
                                                    <input type="file" name="profile_picture"onchange="loadPreview(this);" class="dropify" id="aa" data-max-file-size="1M" />
...
<script>
    ...
    function remove(elem) {
        let imginput=$(elem).parent('div').children('div').html('<img id="preview_img" src="{{ asset('images/profiles/profile.png') }}"class="" width="200" height="150" /><input type="file" name="profile_picture"onchange="loadPreview(this);" class="dropify" id="aa" data-max-file-size="1M" /><p class="text-muted text-center mt-2 mb-0"></p>');
