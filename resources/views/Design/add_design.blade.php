                            ...
                            <div class="row">
                                <div class="col-md-12 row">
                                    <div class="col-md-4 form-group mb-3">
                                        ...
                                        <input class="form-control " id="design_title" type="text" required="required"
                                            name="design_title" placeholder="{{ __('locale.Product Name') }}" />
                                    </div>
                                    <div class="col-md-4 form-group mb-3">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Letter" name="service" required>
                                        <label for="service">{{ __('locale.Letter') }}</label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Resume" name="service">
                                        <label for="service">{{ __('locale.Resume') }}</label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Motivation" name="service">
                                        <label for="service">{{ __('locale.Motivation') }}</label>
                                    </div>
                                    <div class="radio form-check-inline">
                                        <input type="radio" value="Package" name="service">
